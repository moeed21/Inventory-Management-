...
class IMS:
    def __init__(self,root):
        ...
        #------------- title --------------
        image_path = os.path.join(os.getcwd(), "images", "logo1.png")
        ...
        #---------------- left menu ---------------
        menu_logo_path = os.path.join(os.getcwd(), "images", "menu_im.png")
        print("Loading menu logo from:", menu_logo_path)
        ...
        image_path = os.path.join(os.getcwd(), "images", "logo1.png")
        self.icon_title = PhotoImage(file=image_path)
        side_icon_path = os.path.join(os.getcwd(), "images", "side.png")
        print("Loading side icon from:", side_icon_path)
